...
const sessdata = config.SESSION_ID.replace("MINU-XMD~", '');
...
console.log("CONNECTING 𝖬𝖨𝖭𝖴 𝖷𝖬𝖣 🧬...");
...
console.log('𝖬𝖨𝖭𝖴 𝖷𝖬𝖣 CONNECTED TO WHATSAPP ENJOY ✅')

let up = `*╭──────────────●●►*
> *➺ 𝖬𝖨𝖭𝖴 𝖷𝖬𝖣 ᴄᴏɴɴᴇᴄᴛᴇᴅ sᴜᴄᴄᴇssғᴜʟʏ ᴛʏᴘᴇ .ᴍᴇɴᴜ ᴛᴏ ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ ᴄʀᴇᴀᴛᴇᴅ ʙʏ SATHSIDU AGRESARA ✅*
